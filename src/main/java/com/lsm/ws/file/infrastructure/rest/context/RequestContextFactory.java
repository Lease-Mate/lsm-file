...
import com.lsm.ws.file.configuration.exception.unauthorized.JwtAuthenticationException;
import com.lsm.ws.file.domain.user.UserRole;
import com.lsm.ws.file.infrastructure.jwt.JwtClaims;
import com.lsm.ws.file.infrastructure.jwt.JwtExtractor;
