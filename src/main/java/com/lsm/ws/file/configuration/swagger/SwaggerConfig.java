package com.lsm.ws.file.configuration.swagger;
...
public class SwaggerConfig {
    ...
    private static final String LSM_OFFER_GROUP = "lsm-file";
    private static final String LSM_OFFER_PATH = "/v1/api/file/**";
    ...
    public OpenAPI openAPI() {
        var openApi = new OpenAPI().info(new Info().description("LeaseMate file microservice")
